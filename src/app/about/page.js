      ...
      <div className="flex flex-col w-[95%] lg:w-[85%] xl:w-[80%]">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex gap-8">
            ...
            <div className="bg-background3 p-5 rounded-lg">
          ...
          <div className="px-5 py-4 bg-background3 rounded-lg">
            <h1 className="text-4xl">So Far...</h1>
            <p className="text-sm md:text-base xl:text-lg leading-loose">
          ...
          <div className="flex flex-col items-center">
            <p className="pb-2 text-xl">Club Members at the 2022-2023 ICPC</p>
