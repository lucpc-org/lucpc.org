              ...
              <div className="space-x-5 text-4xl">
                ...
                {!(currentUser === null || currentUser === undefined) && (
                  <>
                    ...
                    />
                    <label htmlFor={item.diffName} className="text-text_hover2 group transition-all peer-checked:animate-check_out">
                      <i className="fa-regular fa-circle-check" />
                    </label>
                    <label htmlFor={item.diffName} className="text-text_hover2 group hidden peer-checked:text-easy peer-checked:inline">
